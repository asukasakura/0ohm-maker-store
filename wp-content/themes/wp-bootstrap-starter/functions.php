...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_style('elab-linear-icons', get_template_directory_uri() . '/inc/assets/css/linearicons/linear.css', false, '');
    
    wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/inc/assets/css/dist/custom-style.css', false, '' );
    //Color Scheme
...
//         $items .= '<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" class="cart_box menu-item menu-item-type-post_type menu-item-object-page nav-item">
//                     <a class="nav-link" href="' . wc_get_cart_url() . '" title="View your shopping cart"> <i class="lnricons-cart"></i> ' . sprintf ( _n( '%d', '%d', WC()->cart->get_cart_contents_count() ), WC()->cart->get_cart_contents_count() ) . ' ' . WC()->cart->get_cart_total() . '</a>
//                     <ul class="dropdown-menu" role="menu">
//                         <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-139" class="menu-item menu-item-type-custom menu-item-object-custom nav-item">'
//                     . get_template_part('parts/cart/mini', 'cart') .
//                     '</li> </ul>';
//     }
//     return $items;
// }
